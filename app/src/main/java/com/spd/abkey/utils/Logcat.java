...
import com.spd.abkey.BuildConfig;
...
public final class Logcat {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = AppAbKey.getInstance().getPackageManager()
                    .getPackageInfo(AppAbKey.getInstance().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && AppAbKey.getInstance().getExternalCacheDir() != null) {
                sDefaultDir = AppAbKey.getInstance().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            } else {
                sDefaultDir = AppAbKey.getInstance().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
